...
function ContactForm() {
  ...
  return (
    <>
      <main name="Contact Us" className=" h-auto  py-5 ">
        ...
        <section className="mt-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)}
            ...
            <div>
              ...
              <input name="number" {...register("number", { required: true })} type="number" placeholder=' Please enter a mobile number..' id="number" className="w-full p-3 border border-gray-300 rounded-2xl outline-none" />
              {errors.number && <span className="text-red-600 pl-2.5">This field is required</span>}
            </div>
            <div>
